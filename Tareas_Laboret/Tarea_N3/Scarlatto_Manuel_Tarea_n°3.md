...
- Simulación para m disminuida

![Out_Pendilo_PID_Disminuido](Imagenes/Out_Pendilo_PID_Disminuido.png)

![Plano_de_Fase_Dis](Imagenes/Plano_de_Fase_Dis.png)

![Torque_Dis](Imagenes/Torque_Dis.png)

![Acc_Integral_Dis](Imagenes/Acc_Integral_Dis.png)

- Simulación para m aumentada

![Out_Pendulo_Aum](Imagenes/Out_Pendulo_Aum.png)

![Plano_de_Fases_Aum](Imagenes/Plano_de_Fases_Aum.png)

![Torque_Aum](Imagenes/Torque_Aum.png)

![Acc_Integral_Aum](Imagenes/Acc_Integral_Aum.png)

- Realizando una comparación de las 3 masas.

![Out_Sist_3_m](Imagenes/Out_Sist_3_m.png)

![Diag_Fases_3_m](Imagenes/Diag_Fases_3_m.png)

![Torque_3_m](Imagenes/Torque_3_m.png)

![Acc_Int_3_m](Imagenes/Acc_Int_3_m.png)
